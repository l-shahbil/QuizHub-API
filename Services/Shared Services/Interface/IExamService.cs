...
namespace QuizHub.Services.Shared_Services.Interface
{
    public interface IExamService
    {
        ...
        Task<List<ExamAvalibleDto>> getCompletedExams(string userEmail, int classId);
        ...
        //for student
        Task<ExamCounterViewDto> GetExamCounterForStudent(string userEmail);
        ...
        Task<ExamResultViewDto> ViewExamResult(string? userEmail, string studentEmail, int classId, string examId);
